...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-4
      .col-lg-6
        .p-1.mb-4(style="background: #FFF8DA; border-radius: 10px")
          .row.align-items-center.card2
            .col-lg-2
    ...
    .row.mb-4
      .col-lg-6
        .p-1.mb-4(style="background: #FFEDE7; border-radius: 10px")
          .row.align-items-center.card2
            .col-lg-2
              img(data-aos="zoom-out",src='@/assets/curso/temas/tema4/img3.svg', alt='',width="100px", height="100px")
            .col-lg-9
    ...
    .row.mb-4
      .col-lg-6
        .p-1.mb-4(style="background: #E1EDB5; border-radius: 10px")
          .row.align-items-center.card2
            .col-lg-2
              img(data-aos="zoom-out",src='@/assets/curso/temas/tema4/img3.svg', alt='',width="100px", height="100px")
            .col-lg-9
    ...
    .row.mb-4
      .col-lg-6
        .p-1.mb-4(style="background: #EFF3F6; border-radius: 10px")
          .row.align-items-center.card2
            .col-lg-2
              img(data-aos="zoom-out",src='@/assets/curso/temas/tema4/img3.svg', alt='',width="100px", height="100px")
            .col-lg-9
    ...
    .row.my-4.align-items-center
      ...
      .col-lg-7(data-aos="fade-left")
        p Con la finalidad de lograr la identificación oportuna de estos impactos que puedan afectar la salud de las personas, su entorno y el medio ambiente, para así aplicar medidas y acciones preventivas de control de los riesgos, y evitar llegar a generarlos para luego tener que mitigar y compensar estos impactos y efectos negativos sobre los recursos naturales.
        .row.p-2.align-items-center(style="background:#DEEBAD")
          .col-lg-3
            figure
              img(src='@/assets/curso/temas/tema4/img8.svg', alt='Imagen decorativa', width="100px", height="100px")
          .col-lg-9
            p.mb-0 Esto requiere llevar a cabo el cumplimiento de las normas vigentes y los lineamientos ambientales para el ordenamiento de las actividades industriales de acuerdo con la escala de producción, es decir con el adecuado uso del suelo. Estas normas son: 
    ...
    .row.mb-5
      .col-lg-10.m-auto 
        .py-2(data-aos="fade-up")(style="background: #BDD75B; border-radius: 10px")
          .row 
            .col-lg-3
              figure
                img(src='@/assets/curso/temas/tema4/img9.svg', alt='Imagen decorativa', width="100px" , height="100px")
            .col-lg-9
      ...
      table.text-center
        ...
        thead
          tr
            ...
            th(rowspan="4")(style="background: #FFA686") RECURSOS
            th(rowspan="4")(style="background: #FFA686") PARÁMETROS
          tr
            th(colspan="4")(style="background: #FFA686") RESULTADO
          tr
            th(style="background: #FFA686") 0 ≤ I < 25
            th(style="background: #FFA686") 25 ≤ I < 50 
            th(style="background: #FFA686") 50 ≤ I < 75 
            th(style="background: #FFA686") I ≥ 75 
          tr
            th(style="background: #FFA686") IRRELEVANTE 
            th(style="background: #FFA686") MODERADO
            th(style="background: #FFA686") SEVERO
            th(style="background: #FFA686") CRÍTICO
        tbody
          tr 
            td(rowspan="7") FÍSICOS
            td(rowspan="2") Aire
            td CALIDAD DEL AIRE
